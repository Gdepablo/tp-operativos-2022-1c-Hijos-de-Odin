...
//pagina_t leer_de_swap(int posicion) {
...
//
//
//uint32_t es_igual_a(t_list* lista_paginas,pagina_t paginaPedida) {
//	uint32_t iterador_tabla = 0;
//	for(int i=0; i<list_size(lista_paginas); i++) {
//		pagina_t *aux = list_get(lista_paginas,iterador_tabla);
